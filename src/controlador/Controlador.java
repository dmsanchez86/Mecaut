...
public class Controlador {
    ...
    protected jifRegistroAuto jifRegistroAuto;
    ...
    protected final frmAdmin form;
    protected jifRegistrarCliente jifCliente;
    protected jifActualizarCliente jifActualizarCliente;
    private jifRegistrarMantenimiento jifMantenimiento;
    protected jifListaClientes jifListaClientes;
    protected jifListaAutos jifListaAutos;
    ...
    protected jifRegistrarAuto jifAuto;
    ...
    protected final frmLoggin Login;
    protected final frmCliente frmCliente;
    protected final frmEmpleado frmEmpleado;
    protected jifGrupoClientes jifGrupoClientes;
    ...
    protected jifCuentas jifCuentas;
    ...
    private ControladorModuloClientes controladorClientes;
    ...
    public Controlador() {
        ...
        /* Clases Heredadas */
        controladorClientes = new ControladorModuloClientes();
    }

    /* Formulario Administrador */
    protected void launchFormAdministrator(String id) {
        limpiarInicio();
        /* MENU - CLIENTES */
        // 1. Modulo Clientes
        ...
        form.jmiRegistrarCliente.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                controladorClientes.frmRegistrarCliente("Administrador");
            }
        });
        form.jmiActualizarCliente.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmActualizarCliente("", "Administrador");
            }
        });
        form.jmiListaCliente.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                controladorClientes.frmListaClientes("Administrador");
            }
        });
        form.jmiGrupoClientes.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmGrupoClientes();
            }
        });
        form.jmiRegistrarAuto.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                controladorClientes.frmRegistrarAuto("", "Administrador");
            }
        });
        form.jmiListaAutos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                controladorClientes.frmListaAutos("Administrador");
            }
        });
        form.jmiRegistrarCuenta.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmCuentas();
            }
        });
        // 2. Modulo Servicios
    ...
    protected void evtReportes(String report, String title) {
        JasperViewer jv;
    ...
    /* Formulario Cliente */
    protected void launchFormClient(String id) {
        ...
        frmCliente.jmiRegistrarAuto.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmRegistrarAutoCliente();
            }
        });
        ...
        frmCliente.jmiCerrarSesion.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Login.setVisible(true);
                Login.jtfPassword.setText(null);
            }
        });

        String user = Login.jtfUser.getText().toUpperCase();
    ...
    /* Formulario Empleado */
    protected void launchFormEmployee(String id) {

        frmEmpleado.jmiRegistrarCliente.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmRegistrarCliente("Empleado");
            }
        });
        ...
        frmEmpleado.jmiActualizarCliente.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmActualizarCliente("", "Empleado");
            }
        });
        ...
        frmEmpleado.jmiListaCliente.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmListaClientes("Empleado");
            }
        });
        ...
        frmEmpleado.jmiRegistrarAuto.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmRegistrarAuto("", "Empleado");
            }
        });
        ...
        frmEmpleado.jmiListaAutos.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                controladorClientes.frmListaAutos("Empleado");
            }
        });
...
//        });
        ...
        jifConfiguracionAdmin.jbtActualizarContraseña.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (contrasenaNueva == null ? confContrasena != null : !contrasenaNueva.equals(confContrasena)) {
                    ...
                    String[] v = Gestor.validateUser(d[3], contrasenaVieja);
    ...
    protected void locacionfrm(JInternalFrame j) {
    ...
    protected void setColumnWidths(int[] widths, JTable table) {
    ...
    protected void message(JFrame form, String message, String title, int option){
